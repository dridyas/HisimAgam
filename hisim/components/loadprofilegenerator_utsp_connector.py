...
class UtspLpgConnectorConfig(cp.ConfigBase):
    ...
    name_of_predefined_loadprofile: Optional[str] = "CHR43 Single man with 1 child, with work"
    ...
    def get_default_utsp_connector_config(
        ...
        config = UtspLpgConnectorConfig(
            ...
            name_of_predefined_loadprofile="CHR43 Single man with 1 child, with work",
            predefined_loadprofile_filepaths=None,
            household=Households.CHR43_Single_man_with_1_child_with_work,
